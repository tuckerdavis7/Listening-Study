...
(1, 101, 'Bohemian Rhapsody', 'Freddie Mercury', 1975, FALSE),
(2, 102, 'Imagine', 'John Lennon', 1971, FALSE),
(3, 103, 'Billie Jean', 'Michael Jackson', 1982, FALSE),
(4, 104, 'Like a Rolling Stone', 'Bob Dylan', 1965, FALSE),
(5, 105, 'Hey Jude', 'Paul McCartney', 1968, FALSE),
(6, 106, 'Hotel California', 'Don Henley', 1976, FALSE),
(7, 107, 'Smells Like Teen Spirit', 'Kurt Cobain', 1991, FALSE),
(8, 108, 'Sweet Child O Mine', 'Slash', 1987, FALSE),
(9, 109, 'Rolling in the Deep', 'Adele', 2010, FALSE),
(10, 110, 'Uptown Funk', 'Mark Ronson', 2014, FALSE),
(11, 111, 'Shape of You', 'Ed Sheeran', 2017, FALSE),
(12, 112, 'Blinding Lights', 'The Weeknd', 2019, FALSE);